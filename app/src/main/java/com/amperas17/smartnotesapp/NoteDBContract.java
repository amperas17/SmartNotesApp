...
public final class NoteDBContract {
    ...
    public static final Uri NOTE_TABLE_URI = Uri.parse(CONTENT_AUTHORITY + "/"
            + PATH_NOTE_TABLE);
    ...
    public static final class NoteTable implements BaseColumns{
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/" + CONTENT_URI + "/" + PATH_NOTE_TABLE;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/" + CONTENT_URI + "/" + PATH_NOTE_TABLE;
        ...
        public static final int NO_PRIORUTY = 0;
        public static final int LOW_PRIORUTY = 1;
        public static final int MEDIUM_PRIORUTY = 2;
        public static final int HIGH_PRIORUTY = 3;
